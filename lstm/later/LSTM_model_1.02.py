...
EPOCHS:     int = 25   # Hard ceiling; EarlyStopping fires well before this.

# ── LSTM architecture ─────────────────────────────────────────────────────────
LSTM_UNITS_1:  int   = 1024    # First LSTM layer (capacity).
LSTM_UNITS_2:  int   = 512    # Second LSTM layer (compression).
DROPOUT_RATE:  float = 0.2   # Inter-layer dropout fraction.
L2_FACTOR:     float = 0.001   # Kernel weight decay.
...
RECURRENT_DROPOUT_RATE: float = 0.35
